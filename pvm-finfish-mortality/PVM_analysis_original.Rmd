...
### Baseline Monthly Mortality Summary (2003â€“2024)
...
# filter sites for REM at high threshold 
...
Weâ€™ve define â€œpersistentâ€ causes as those that:
Appear in â‰¥2 distinct stock cycles at the same site,
...
```
Weâ€™ve define â€œpersistentâ€ causes as those that:
Appear in â‰¥2 distinct stock cycles at the same site with at least one consecutive run,
...
DATA_PATH <- "data/data_for_app_development.csv"
